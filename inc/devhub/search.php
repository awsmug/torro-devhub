 ...
 */
function torro_devhub_devhub_add_query_var( $query_vars ) {
	$query_vars[] = 'reference';

	return $query_vars;
}
add_filter( 'query_vars', 'torro_devhub_devhub_add_query_var' );
 ...
 */
function torro_devhub_devhub_adjust_search( $query ) {
	...
	if ( '()' === substr( $search, -2 ) ) {
		...
		$query->set( 'post_type', torro_devhub_devhub_get_post_types() );
	} else {
		...
		$devhub_post_types = torro_devhub_devhub_get_post_types();
...
add_action( 'pre_get_posts', 'torro_devhub_devhub_adjust_search', 20, 1 );
 ...
 */
function torro_devhub_devhub_rerun_empty_exact_search( $posts, $query ) {
...
add_filter( 'the_posts', 'torro_devhub_devhub_rerun_empty_exact_search', 10, 2 );
