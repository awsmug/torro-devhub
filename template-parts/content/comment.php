...
<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
	<footer class="comment-meta">
		<div class="comment-author vcard">
			...
			printf( __( '%s <span class="says">says:</span>', 'torro-devhub' ),
		...
		<div class="comment-metadata">
			<a href="<?php echo esc_url( get_comment_link( $comment, $comment_args ) ); ?>">
				<time datetime="<?php comment_time( 'c' ); ?>">
					...
					printf( __( '%1$s at %2$s', 'torro-devhub' ), get_comment_date( '', $comment ), get_comment_time() );
					?>
				</time>
			</a>
			<?php edit_comment_link( __( 'Edit', 'torro-devhub' ), '<span class="edit-link">', '</span>' ); ?>
