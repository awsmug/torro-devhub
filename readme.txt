...
2. Type in 'Torro DevHub' in the search form and press the 'Enter' key on your keyboard.
...
Torro DevHub supports the following plugins:
...
Torro DevHub WordPress Theme, Copyright (C) 2017 Felix Arntz
...
Torro DevHub bundles the following third-party resources:
